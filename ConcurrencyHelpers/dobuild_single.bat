...
msbuild %PROJECT_DIR%/%PROJECT_NAME%.csproj /p:TargetFrameworkVersion=v%FRAMEWORK_VERSION%;Configuration=Release;Platform=AnyCPU /p:DefineConstants=%FRAMEWORK_NUGET_VERSION%
